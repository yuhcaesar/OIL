	...
	<div class="header">
        ...
        <div id="content-l">
           <div class="list-content">
                <p style ="margin-left:550px;margin-top:20px;">管道电位直流电压</p>
                <div style =" border:1px solid black;height:800px;width:1200px;background-color:#ECF5FF;margin-top:20px;">
                     <div style="">                          
                     <!--  <a href="getFBListAction.action?type=news" class="aa" target="_blank">科技资讯</a>-->
                     ...
                     <a href="getDevDetail6Action.action">杂散电流交流电压RMS值</a>&nbsp&nbsp&nbsp&nbsp                                                  
		               ...
		               <table border="1" style="margin-left:350px;">
                           <tr>                           
                              ...
                              <th style="height:50px;width:100px">维度</th>
                              <th style="height:50px;width:200px">时间</th>
                            </tr>                           
                            <c:if test="${!empty fal}">
								<s:iterator value="fal" id="fal">  			                				
			                      <tr>                                  
                                    <td style="height:50px;width:100px"><s:property value="#fal.data1"/> </a></td>                                   
                                    ...
                                    <td style="height:50px;width:100px"><s:property value="#fal.data8"/> </a></td> 
                                     <td style="height:50px;width:200px"><s:property value="#fal.time"/> </a></td>                                 
                                  </tr>
		                    	</s:iterator>
		                    </c:if>		                                              
                        </table>                                                                                      
