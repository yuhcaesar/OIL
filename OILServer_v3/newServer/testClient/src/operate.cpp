...
unsigned char period_new[] = {
    0x21, 0x23, 0x3C, 0x3C, 0x3C, 0x3C, 0x31, 0x31, 0x53, 0x68, 0x65, 0x6E, 0x59, 0x61, 0x6E, 0x67, 0x2D, 0x30, 0x30, 0x31, 0x31, 0x35, 0x00, 0x12, 0x00, 0x05, 0x02, 0x05, 0x0A, 0x00, 0x00, 0x0F, 0x02, 0x03, 0x00, 0x0C, 0x84, 0x53, 0x01, 0x01, 0x3E, 0x3E 
};
...
int main()
{
    ...
    */
        ...
        //while(sendString!= "")
    {
        ...
        if(write(clientSock,assistdata,sizeof(assistdata))==-1)
        {
            printf("send error!\n");
        }
        /*
